...
class WebGLPhysicsBoxShape extends WebGLPhysicsShape {
    ...
    WebGLPhysicsBoxShape({double margin: 0.04, Float32List halfExtents}) {
      ...
      inertia = new Vector3((1.0 / 12.0) * (ly + lz),
          (1.0 / 12.0) * (lx + lz),
          (1.0 / 12.0) * (lx + ly));
    ...
    void localSupportWithoutMargin(Float32List vec, Float32List dst) {
        var v0 = vec[0];
        var v1 = vec[1];
        var v2 = vec[2];
