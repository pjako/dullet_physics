...
class WebGLContactEPA {
    ...
    final Hs hull = new Hs(); // TODO: { root : null, count : 0 };
    final Hs stock = new Hs(); // TODO: { root : null, count : 0 };
    final Horizon horizon = new Horizon(); // TODO { cf : null, ff : null, numFaces : 0 };
    ...
    WebGLContactEPA() {
        ...
        //vertex_store = new Float32List(MAX_VERTICES * 9);
