...
//
class WebGLPhysicsSphereShape extends WebGLPhysicsShape
{
    //static version = 1;
    ...
    WebGLPhysicsSphereShape({
      ...
      sphereRadius = radius;
      _radius = sphereRadius + margin;
      _collisionRadius = radius + margin;
      _halfExtents = new Vector3(radius + margin, radius + margin, radius + margin);
      _inertia = new Vector3(i, i, i);
    ...
    void set margin(double margin) {
      _margin = margin;
      _collisionRadius = _radius + _margin;
      _halfExtents.x = _collisionRadius;
      _halfExtents.y = _collisionRadius;
      _halfExtents.z = _collisionRadius;
      _radius = _collisionRadius;
    }
    double get margin => _collisionRadius - _radius;
